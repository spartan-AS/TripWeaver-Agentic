...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport": "stdio",
            "command": r"C:\Users\OPTLPTP481\Desktop\TripWeaver-with Advanced Feature\aviationstack-mcp\.venv\Scripts\python.exe",
            "args": [
                "-m",
                "aviationstack_mcp",
                "mcp",
        ...
        "weather": {
            "transport": "stdio",
            "command": r"C:\Users\OPTLPTP481\Desktop\TripWeaver-with Advanced Feature\weather-mcp-server\.venv\Scripts\python.exe",
            "args": [
                r"C:\Users\OPTLPTP481\Desktop\TripWeaver-with Advanced Feature\weather-mcp-server\weather_mcp_server.py"
            ],
            "env": {
